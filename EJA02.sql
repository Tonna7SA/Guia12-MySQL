...
SELECT distinct fabricante.nombre FROM fabricante LEFT JOIN producto
ON fabricante.codigo != producto.codigo_fabricante  
...
select producto.nombre, precio from fabricante inner join producto
on fabricante.codigo = producto.codigo_fabricante
where fabricante.nombre = 'lenovo' and producto.precio = (Select max(precio))limit 1;

SELECT producto.nombre
FROM fabricante INNER JOIN producto
ON fabricante.codigo = producto.codigo_fabricante
WHERE fabricante.nombre = 'Lenovo' AND producto.precio = (
SELECT MAX(precio) FROM fabricante INNER JOIN producto
ON fabricante.codigo = producto.codigo_fabricante
...
*/
select * from fabricante inner join producto
on fabricante.codigo = producto.codigo_fabricante
where fabricante.nombre = 'Asus' and producto.precio > (select avg(precio)
from fabricante inner join producto
on fabricante.codigo = producto.codigo_fabricante
